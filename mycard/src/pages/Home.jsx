...
const Home = () => {
    ...
    return (
        <div className='flex mx-4 md:mx-12 flex-col md:flex-row justify-between h-screen overflow-hidden'>
            
            {/* Left Side - Hidden on mobile */}
            <div className="hidden lg:block lg:sticky lg:top-5 h-screen overflow-y-auto left-side mt-5">
                {/* Commented out profile card content */}
            </div>

            {/* Middle Section - Full width on mobile */}
            <div className="middle flex-grow overflow-y-auto w-full md:mx-4">
               <SocialMediaPost />
            </div>

            {/* Right Side - Hidden on mobile */}
            <div className="hidden lg:block right-side mt-5 lg:top-5 h-66 no-scrollbar">
                <div className='lg:w-76 bg-white shadow-sm rounded-[20px] flex flex-col justify-center items-center text-xs'>
                    <div className='w-full flex justify-between p-3'>
                        <h1>Add to your feed</h1>
                        <MoveRight />
                    </div>
