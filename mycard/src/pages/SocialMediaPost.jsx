...
const SocialMediaPost = () => {
  ...
  return (
    ...
    //                           {/* Reply indicator */}
    //                           {replyingTo[announcement.name] && (
    //                             <div className="mb-4 flex items-center justify-between bg-blue-50 px-4 py-2 rounded-xl">
    ...
    //                               <button 
    //                                 onClick={() => handleCommentSubmit(announcement.name)}
    //                                 className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-medium hover:shadow-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
    //                               >
    //                                 <Send className="w-4 h-4" />
    //                               </button>
    //                             </div>
    ...
    //                                     <div className="flex-1">
    //                                       <div className="bg-white rounded-2xl px-4 py-3 shadow-sm border border-gray-100">
    //                                         <div className="font-semibold text-gray-900 text-sm">{commentItem.user_name || "Anonymous"}</div>
    ...
    //                                       {commentItem.replies.map(reply => (
    //                                         <div key={reply.name} className="flex items-start space-x-3">
    //                                           <img 
    ...
    //                                           <div className="flex-1">
    //                                             <div className="bg-white rounded-2xl px-4 py-3 shadow-sm border border-gray-100">
    //                                               <div className="font-semibold text-gray-900 text-sm">{reply.user_name || "Anonymous"}</div>
