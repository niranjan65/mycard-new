            ...
            <div className="hidden lg:flex items-center justify-between px-6 py-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="relative" ref={appMenuRef}>
                  ...
                  {/* Apps Dropdown */}
                  {showAppMenu && (
                    <div className="absolute top-full right-0 mt-3 w-72 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700/30 py-3 animate-in slide-in-from-top-2 duration-200">
