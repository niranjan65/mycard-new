  ...
  const validateForm = () => {
    ...
    requiredFields.forEach(field => {
      if (!formData[field] || (typeof formData[field] === "string" && !formData[field].trim())) {
        errors[field] = true; // You may extend with error messages here
      }
    });
    ...
    if (cardData) {
      setFormData(prev => ({
        ...
        ...{
          ...
          resident_status: cardData.resident_status || '',
          province: cardData.province || '',
          province1: cardData.province1 || '',
          province2: cardData.province2 || '',
          postal_code: cardData.postal_code || '',
          postal_code1: cardData.postal_code1 || '',
          country: cardData.country || 'Papua New Guinea',
          country1: cardData.country1 || 'Papua New Guinea',
          country2: cardData.country2 || 'Papua New Guinea',
          office_contact_no_country_code: cardData.office_contact_no_country_code ? `+${cardData.office_contact_no_country_code}` : '+675',
          personal_contact_no_country_code: cardData.personal_contact_no_country_code ? `+${cardData.personal_contact_no_country_code}` : '+675',
          personal_email_address: cardData.personal_email_address || '',
          phone_no: cardData.phone_no || '',
          town: cardData.town || '',
          town1: cardData.town1 || '',
              ...
              /*Boolean(cardData) == false ? (
                ...
                <div className="action-buttons">
                  ...
                  <button
                    ...
                    className="btn btn-submit"
                  >
                    {isupdating ? 'Edit Enabling...' : 'Edit Application'}
                  </button>
                </div>
              )
            )*/
